package im.vinci.core.metatype.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializeConfig;
import com.alibaba.fastjson.serializer.SimpleDateFormatSerializer;
import im.vinci.core.metatype.Dto;
import im.vinci.core.metatype.util.TypeCaseHelper;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	...
	public String toJson(String pFormat){
		...
		mapping.put(Date.class,new SimpleDateFormatSerializer(pFormat));
		strJson = JSON.toJSONString(this, mapping);
		return strJson;
	}
