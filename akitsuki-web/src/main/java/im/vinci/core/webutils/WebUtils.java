...
public class WebUtils {
	...
	public static Dto getCurrentUser(HttpServletRequest request) {
		...
		if (obj2 == null) {
			//log.info("获取SPRING_SECURITY_CONTEXT为空!!!");
