package im.vinci.core.id.sequence;

import im.vinci.core.id.CreateSequnceException;
import im.vinci.core.id.InitSequenceGeneratorException;
import im.vinci.core.id.SequenceGenerator;
import im.vinci.core.id.SequenceStorer;
import im.vinci.core.id.storer.FileSequenceStorer;
